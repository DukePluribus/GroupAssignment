...
public class Model {
    ...
    public static boolean verifyCredentials(String _username, String _password) {
        try {
            ...
            if((jsonObject.containsValue(_username)==true)&&jsonObject.containsValue(_password)==true){
                if((jsonObject.get(_username)).equals(jsonObject.get(_password))==true) {
                    return true;
                }
                else{
                    return false;
    ...
    public static boolean registerUser(String username, String email, String password) {
        if(verifyCredentials(username, password)==true) {
            ...
            try {
                ...
                jsonObject.put("isTutor", false);
                FileWriter fileWriter = new FileWriter("C:\\Users\\madel\\IdeaProjects\\CS410GroupProject\\src\\usersDB");
